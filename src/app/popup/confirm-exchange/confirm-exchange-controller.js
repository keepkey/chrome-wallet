...
angular.module('kkWallet')
  .controller('ConfirmExchangeController', [
    ...
    function ($scope, deviceBridgeService, exchangeService, walletNodeService) {
      ...
      $scope.withdrawalAccountName =
        walletNodeService.getWalletById($scope.withdrawalAccount).name;
      $scope.withdrawalCurrencyName =
        walletNodeService.getWalletById($scope.withdrawalAccount).coinType;
